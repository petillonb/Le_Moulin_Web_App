...
export class NouveauProfileJeuneComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.jeuneOriginalData = structuredClone(this.jeuneData);
    console.log(this.jeuneData.identite_id.contact_id);
  ...
  fillIdentiteOptionList(){
    ...
    console.log(this.optionsIdentite);
    
  }
  patchValue() {
    console.log("patchting value");
    console.log("patchting formJeune");
    ...
    if (this.jeuneData.identite_id) {
      ...
      if (this.jeuneData.identite_id.contact_id) {
        console.log("patchting formJeuneContact");
        this.formJeune.patchValue({
    ...
    if (this.jeuneData.famille_id) {
      console.log("patchting formFamille");
      ...
      if (this.jeuneData.famille_id.parentA_id) {
        console.log("patchting formParentAId");
        ...
        if (this.jeuneData.famille_id.parentA_id.contact_id) {
          console.log("patchting formParentAContact");
          this.formParentA.patchValue({
      ...
      if (this.jeuneData.famille_id.parentB_id) {
        console.log("patchting formParentBId");
        ...
        if (this.jeuneData.famille_id.parentB_id.contact_id) {
          console.log("patchting formParentBContact");
          this.formParentB.patchValue({
    ...
    if (this.jeuneData.prof_principale_id) {
      console.log("patchting formProfId");
      ...
      if (this.jeuneData.prof_principale_id.contact_id) {
        console.log("patchting formProfContact");
        this.formProf.patchValue({
  ...
  updateJeuneData() {
    ...
    if (this.jeuneData.identite_id) {
      ...
      if (this.jeuneData.identite_id.contact_id) {
        console.log("updating JeuneContactData");
    ...
    if (this.jeuneData.famille_id) {
      ...
      if (this.jeuneData.famille_id.parentA_id) {
        ...
        if (this.jeuneData.famille_id.parentA_id.contact_id) {
          console.log("updating ParentAContactData");
      ...
      if (this.jeuneData.famille_id.parentB_id) {
        console.log("updating ParentBIdData");
        ...
        if (this.jeuneData.famille_id.parentB_id.contact_id) {
          console.log("updating ParentBContactData");
    ...
    if (this.jeuneData.prof_principale_id) {
      console.log("updating ProfIdData");
      ...
      if (this.jeuneData.prof_principale_id.contact_id) {
        console.log("updating ProfContactData");
